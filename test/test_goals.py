...
def test_proba():
    ...
    np.testing.assert_almost_equal(poisson_goals.predict_proba(1,0), 0.1091737792884785,5)
    np.testing.assert_almost_equal(poisson_goals.predict_proba(2,3), 0.0158411626833959,5)
